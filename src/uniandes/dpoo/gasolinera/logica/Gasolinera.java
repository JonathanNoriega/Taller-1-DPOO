...
public class Gasolinera
{
    ...
    public int venderGasolinaPorCantidad( String nombreTipoGasolina, double cantidadSolicitada, int numeroSurtidor )
    {
        ...
        catch( GasolinaInsuficienteException e )
        {
            ...
            cantidadEntregada = Math.abs(e.getCantidadDisponible( ));
            try
            {
    ...
    {
        TipoGasolina tipo = tiposGasolina.get( nombreTipoGasolina );
        double cantidadSolicitada = Math.abs(valorSolicitado / ( double )tipo.getPrecioPorGalon( ));

        return Math.abs(venderGasolinaPorCantidad( nombreTipoGasolina, cantidadSolicitada, numeroSurtidor ));
    }
